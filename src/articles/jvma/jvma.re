...
//image[nri][NRI Currenza C2][scale=0.5]
//}
...
//image[ag100][コンラックス CLXA-G100シリーズ][scale=0.2]
//image[730a][旭精工 730-A][scale=0.2]
//}
...
//image[bve21s4][富士電機 BVE21S4][scale=0.2]
//image[m400][コンラックス NBX(R)-M400シリーズ][scale=0.3]
//image[nb][コンラックス NB-4MB80シリーズ][scale=0.4]
//}
...
//footnote[vccs][VCCSとも呼ばれるようです。シリアル通信のため「シリアル伝送方式」とも、また後述の特許を読むと「ベンダーコントロールシステム」「VCSバス」「Vender Control Coca-Cola System」と書かれていることもありました。あと海外メーカーの資料だと「JPSTD」とも。]
...
でもやっぱり必ずしも券売機まで買う必要はあったか、特許+取扱説明書に加えて試行錯誤すれば目的は達成出来たのではと思う気持ちもあります。
//image[ticketvend][らめぇしぐこう開店][scale=0.49]
//footnote[jihanki][もともとラーメン屋（閉店済み）で使われていたようです。食べログなどを見ると現役で動いている姿が見られます。]
...
コマンドについては記載しません。
物理層とデータリンク層については特許由来の情報のためおおっぴらに出典を示せます。
...
あとパネルは作っていませんが、いずれアクリル板とかで覆いたいですね。
1枚だけの加工ならアクセアが一番安くて手軽と思っている@<fn>{uv}のでそこに頼む予定です。
//footnote[uv][アクリル板のUV印刷も一番安いと思っています。透明アクリルには裏面に白版を設定する必要があります。そして白版はカラーよりも少し小さくする必要があり、これは細らせと呼ばれます。わからせみたいですね。わたらせ渓谷鐵道、おしなガキ (575)]
